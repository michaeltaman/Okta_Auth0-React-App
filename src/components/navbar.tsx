...
import React, { useState, useEffect } from 'react';
  ...
  const mockdata = [
    {
      icon: IconCode,
      title: 'Concept source code',
      description: 'This gives concept of the source code',
    },
    {
      icon: IconCoin,
      title: 'Payment conditions',
      description: 'Customized payment options to suit your needs.',
    },
    {
      icon: IconBook,
      title: 'Documentation',
    ...
    },
    {
      icon: IconChartPie3,
      title: 'Analytics',
      description: 'Check how people are liking your concepts',
    },
    {
